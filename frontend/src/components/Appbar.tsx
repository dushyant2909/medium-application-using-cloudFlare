      ...
      <div className="hidden md:flex justify-between items-center px-10 py-2">
        ...
        <div className="flex items-center">
          <Link to={`/publish`}>
            <button
              type="button"
              className="mr-4 text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full px-5 py-2.5 text-center"
            >
              + Add blog
            </button>
          </Link>
